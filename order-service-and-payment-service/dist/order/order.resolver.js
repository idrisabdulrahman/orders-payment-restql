...
const order_resolver_base_1 = require("./base/order.resolver.base");
const Order_1 = require("./base/Order");
const order_service_1 = require("./order.service");
let OrderResolver = class OrderResolver extends order_resolver_base_1.OrderResolverBase {
    service;
    rolesBuilder;
