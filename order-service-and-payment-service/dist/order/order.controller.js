...
const order_controller_base_1 = require("./base/order.controller.base");
let OrderController = class OrderController extends order_controller_base_1.OrderControllerBase {
    service;
    rolesBuilder;
