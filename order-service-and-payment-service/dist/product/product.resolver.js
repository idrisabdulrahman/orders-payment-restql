...
const product_resolver_base_1 = require("./base/product.resolver.base");
const Product_1 = require("./base/Product");
const product_service_1 = require("./product.service");
let ProductResolver = class ProductResolver extends product_resolver_base_1.ProductResolverBase {
    service;
    rolesBuilder;
